...
export BASE_MODEL="/content/TinyZero/model/Qwen2.5-0.5"
export DATA_DIR="/content/TinyZero/data/countdown"
export ROLLOUT_TP_SIZE=1
export EXPERIMENT_NAME=countdown-qwen2.5-0.5b-countdown
